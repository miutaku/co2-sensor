...
BuildArch:      noarch
BuildRequires:  python3, python3-setuptools, python3-flask, python3-pip, python3-yaml
Requires:       python3, python3-flask, python3-pip, python3-yaml
...
%changelog
* Tue Jul 01 2025 miutaku <miutaku@miutaku.work> - 0.1.0-1
- Initial package
